...
public class TestList {
    ...
    public void setUp() throws Exception {
        ...
        // Answer: Using a linked list made no difference - we'll check the performance next!
    ...
    public void testAddMultiple() {
        ...
        list.add(77);
        // Done fix the expected values in the assertions below
        // indexOf returns index of first occurence, lastIndexOf returns last occurence
    ...
    public void testRemoveObject() {
        ...
        list.add(77);
        list.add(6);
        list.remove(5); // Removes the element at the specified index location
        // Done fix the expected values in the assertions below
        ...
        assertEquals(77, list.get(3).intValue());
        list.remove(Integer.valueOf(5)); // Removed the first occurrence of an Integer equal to 5 in the list.
